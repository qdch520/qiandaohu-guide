...
export const SPOTS: Spot[] = [
  ...
  },
  {
    ...
    name: "月光岛 · 龙山岛 · 渔乐岛",
    area: "中心湖区",
    see: "同一条船线常停这几岛：月光岛（五龙岛）偏爱情步道、状元桥；龙山岛有海瑞祠、书院，偏人文；渔乐岛可喂鱼，也是少有能吃饭的岛。船班不同，停哪几岛不一样。",
    kid: "喂鱼比祠堂更对 6 岁胃口。岛上跟着队伍走，码头边拉紧孩子。",
    pay: "上岛一般含在中心湖区船票。喂鱼、岛上餐另付。",
    xhsKeyword: "千岛湖 渔乐岛 喂鱼",
    photos: [],
    noPhoto:
      "这三岛没有找到能核对地点和年份的近年实拍，不配图。别把别的湖区照片当成这几岛。",
  },
  {
    id: "huangshanjian",
    name: "黄山尖 · 天下为公",
